...
bool Satellite11Audio::begin() {
    // Satellite1.1 native audio path is 48 kHz, stereo, 32-bit. The Voice Satellite
...
size_t Satellite11Audio::readPcm16(int16_t* dst, size_t samples, uint32_t) {
    ...
    for (size_t i = 0; i < outCount; ++i) {
        // Use the first XMOS channel for Voice Satellite voice uplink. XMOS performs the
